...
#read the csv file
df=pd.read_csv("F:/6th Semester/Talent Battle/Week 3/stress.csv",encoding="latin-1",low_memory =False)
df.head()
...
#It os used for prepare the text column by the data cleaning means all unneccesary symbols will remove
import nltk
import re
